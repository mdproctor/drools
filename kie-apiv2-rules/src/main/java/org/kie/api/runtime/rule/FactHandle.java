...
public interface FactHandle<T> {
    ...
    /**
     * @NOTE I'm temporarily exposing this, to get things compiling. I don't like publicly hard coding isNegated. As this is just potentially
     * one mode that we could support. (mdp)
     *
     * @return
     */
