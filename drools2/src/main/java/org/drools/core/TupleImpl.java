...
public abstract class TupleImpl implements Tuple<TupleImpl> {
    ...
    protected InternalDataHandle handle;
    ...
    public TupleImpl(InternalDataHandle factHandle,
                     Sink sink,
    ...
    public InternalDataHandle getFactHandle() {
        return handle;
    }

    public InternalDataHandle getHandle() {
        return handle;
    }
     ...
     */
    public InternalDataHandle getOriginalFactHandle() {
        InternalDataHandle linkedFH = handle.isEvent() ? ((InternalDataHandle)handle).getLinkedFactHandle() : null;
        return linkedFH != null ? linkedFH : handle;
    }

    public void setFactHandle( FactHandle handle ) {
        this.handle = (InternalDataHandle) handle;
    }
