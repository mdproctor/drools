    ...
    private boolean evaluate(MvelEvaluator<Boolean> evaluator, FactHandle handle, ValueResolver valueResolver, BaseTuple tuple) {
        if (compilationUnit == null) {
            ...
            if (operators.length > 0) {
                ...
                FactHandle[] handles = tuple != null ? tuple.toFactHandles() : new InternalFactHandle[0];
        ...
        compilationUnit.updateFactory( handle, tuple, null, valueResolver, valueResolver.getGlobalResolver(), factory );
