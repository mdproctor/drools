...
public interface PredicateExpression
    ...
    class SafePredicateExpression implements PredicateExpression, Serializable {
        ...
        public boolean evaluate(final FactHandle handle,
            ...
            return AccessController.doPrivileged(
                    (PrivilegedExceptionAction<Boolean>) () -> delegate.evaluate(handle, tuple, previousDeclarations, localDeclarations, valueResolver, context), KiePolicyHelper.getAccessContext());
        }
