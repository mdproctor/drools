 ...
 */
public class HashTableIterator<T>
    implements
    Iterator<T>,
    Externalizable {
    ...
    private AbstractHashTable<T> hashTable;
    private TupleList<T>[]       table;
    public  int                  row;
    private int                  length;
    private TupleList<T>         entry;

    public HashTableIterator() {
    }

    public HashTableIterator(final AbstractHashTable<T> hashTable) {
    ...
    public void readExternal(ObjectInput in) throws IOException,
        ...
        hashTable = (AbstractHashTable<T>) in.readObject();
        table = (TupleList<T>[]) in.readObject();
        row = in.readInt();
        length = in.readInt();
        entry = (TupleList<T>) in.readObject();
    }
