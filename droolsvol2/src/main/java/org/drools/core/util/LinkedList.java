 ...
 * </pre>
 */
public class LinkedList<T extends DoubleLinkedNode<T>>
    implements
    Externalizable {
...
//        }
    ...
    public static class TMSLinkedListFastIterator<K extends SingleLinkedNode<K>> implements FastIterator<K> {
     ...
     * @return
     */
    public static class LinkedListIterator<T extends DoubleLinkedNode<T>>
        implements
        Iterator<T>,
        Externalizable {
    ...
    public static class JavaUtilIterator<T extends DoubleLinkedNode<T>>
        implements
