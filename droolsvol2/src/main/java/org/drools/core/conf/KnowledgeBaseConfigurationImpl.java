 ...
 * </pre>
 */
public class KnowledgeBaseConfigurationImpl extends BaseConfiguration<KieBaseOption, SingleValueKieBaseOption, MultiValueKieBaseOption>
    implements
    KieBaseConfiguration,
    Externalizable {
    private static final long serialVersionUID = 510l;

    protected static final transient Logger logger = LoggerFactory.getLogger(KnowledgeBaseConfigurationImpl.class);

    public static final ConfigurationKey<KnowledgeBaseConfigurationImpl> KEY = new ConfigurationKey<>("Base");
     ...
     * @param compConfig
     */
    public KnowledgeBaseConfigurationImpl(CompositeConfiguration<KieBaseOption, SingleValueKieBaseOption, MultiValueKieBaseOption> compConfig) {
        super(compConfig);
        init();
    }
