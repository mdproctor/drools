...
import org.drools.core.BuildtimeSegmentUtilities;
...
//    }
//
//    default PathMemSpec calculatePathMemSpec(BaseNode startTupleSource, TerminalNode removingTN) {
//        int counter = 1;
//        long allLinkedTestMask = 0;
//
//        BaseNode tupleSource = getLeftTupleSource();
//
...
//            }
//
//            tupleSource = tupleSource.getLeftParent();
//            if ( BuildtimeSegmentUtilities.isNonTerminalTipNode(tupleSource, removingTN) ) {
...
//            }
//
//            if ( tupleSource == startTupleSource.getLeftParent() ) {
...
//    }
//
//    static boolean hasConditionalBranchNode(BaseNode tupleSource) {
//        while (  !NodeTypeEnums.isLeftInputAdapterNode(tupleSource) ) {
