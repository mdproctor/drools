 ...
 */
public interface Memory extends DoubleLinkedNode<Memory> {
    
    int getNodeType();
    
    SegmentMemory getSegmentMemory();

//    default SegmentMemory getOrCreateSegmentMemory( BaseNode tupleSource, ReteEvaluator reteEvaluator ) {
