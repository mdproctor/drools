...
public class BuildContext implements RuleBuildContext {
    ...
    public BuildContext(RuleBase ruleBase) {
    ...
    public void syncObjectTypesWithObjectCount() {
        ...
        if (leftInput != null) {
            while (this.patterns.size() > leftInput.getObjectIndex()) {
    ...
    /**
     * @param rightInput the objectSource to set
     */
    ...
    /**
     * @param leftInput the tupleSource to set
     */
    public void setLeftInput(final BaseNode leftInput) {
    ...
    public int getNextNodeId() {
        return ruleBase.getReteBuilder().getNodeIdsGenerator().getNextId();
    }

    public int getNextMemoryId() {
        return ruleBase.getReteBuilder().getMemoryIdsGenerator().getNextId();
    }
    ...
    public void releaseId(NetworkNode node) {
        ruleBase.getReteBuilder().releaseId(node);
    }
