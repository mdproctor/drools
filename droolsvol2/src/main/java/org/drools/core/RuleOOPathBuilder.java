...
public class RuleOOPathBuilder {
    ...
    public static class Path3<END, T extends BaseTuple, A, B, C> extends BasePath<END, A, B, T> {
    ...
    public static class Path4<END, T extends BaseTuple, A, B, C, D> extends BasePath<END, A, B, T> {
    ...
    public static class Path5<END, T extends BaseTuple, A, B, C, D, E> extends BasePath<END, A, B, T> {
    ...
    public static class Path6<END, T extends BaseTuple, A, B, C, D, E, F> extends BasePath<END, A, B, T> {
