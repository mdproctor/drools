...
public abstract class LambdaAccumulator implements Accumulator {
    ...
    public Object accumulate(Object workingMemoryContext, Object context, BaseTuple leftTuple, FactHandle handle, Declaration[] declarations, Declaration[] innerDeclarations, ValueResolver valueResolver) {
        final Object accumulatedObject = getAccumulatedObject(declarations, innerDeclarations, handle, leftTuple, valueResolver);
        return accumulateFunction.accumulateValue( (Serializable) context, accumulatedObject);
    }

    protected abstract Object getAccumulatedObject( Declaration[] declarations, Declaration[] innerDeclarations, FactHandle handle, BaseTuple tuple, ValueResolver valueResolver );
    ...
    public static class BindingAcc extends LambdaAccumulator {
        ...
        @Override
        protected Object getAccumulatedObject( Declaration[] declarations, Declaration[] innerDeclarations, FactHandle handle, BaseTuple tuple, ValueResolver valueResolver ) {
            ...
            if (accumulateObject instanceof SubnetworkTuple ) {
                ...
                return binding.evaluate(handle, tuple, valueResolver, declarations, innerDeclarations);
            }
        }
